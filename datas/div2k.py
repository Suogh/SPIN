...
class DIV2K(data.Dataset):
    def __init__(
        ...
        for i in range(self.start_idx, self.end_idx):
            ...
            lr_filename = os.path.join(self.LR_folder, 'X{}'.format(self.upscale),
                                       idx + 'x{}'.format(self.upscale) + self.img_postfix)
        ...
        lr_dir = os.path.join(self.cache_dir, 'div2k_lr_x{}'.format(self.upscale),
